    ...
    <header class="navbar sticky-top">
        <div class="container-fluid px-md-5">
            ...
            <div class="nav-right d-flex align-items-center gap-2">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="icon-btn px-3 nav-links py-1 text-black opacity-75 link-offset-2 link-underline link-underline-opacity-0">Login</a>
                    <a href="{{ route('register') }}"
                        class="icon-btn px-3 py-1 text-black opacity-75 link-offset-2 link-underline link-underline-opacity-0">Register</a>
                @endauth
            </div>
        </div>
    </header>
        ...
        <section class="hero container py-5">
            <div class="row align-items-center g-5 ">
                <div class="col-lg-6 hero-text text-center text-lg-start">
                    ...
                    <div
                        class="hero-stats d-flex justify-content-center justify-content-lg-start gap-4 pt-4 border-top">
